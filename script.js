...
async function saveFood() {
  ...
  try {
    ...
    const id=await idb.addCalories(db, { // added const id = await..... to save the id of a food item
      foodName,
      calories,
      selectedCategory,
      selectedDate,
...
function _renderFoodListItem(foodName, calories, selectedCategory,id) { // added id
